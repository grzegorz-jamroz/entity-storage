...
class ModifyAction implements Executable
{
    /**
    ...
    {
        $entity = (new FindAction($this->uuid, $this->entityFactory, $this->fileFactory))->acquire();
        $data = [
            ...$entity->jsonSerialize(),
            ...$this->data,
            'uuid' => $this->uuid,
        ];
        $this->fileFactory->getFileByUuid($this->uuid)->overwrite(
            $this->entityFactory->create($data)->jsonSerialize(),
